          ...
          <ScrollReveal key={testimonial.name} delay={index * 0.08}>
            <Card className="glass-panel glass-clay clay-lift h-full border-glass-border p-2">
              <CardContent className="h-full">
                {/* `figure`/`blockquote`/`figcaption`: the attribution is the
                    quote's caption, not a sibling paragraph. */}
                <figure className="flex h-full flex-col">
                  {/* Clay-toned quote mark — decorative glyph, not body text. */}
                  <Quote className="mb-4 size-7 text-primary-text" aria-hidden="true" />
                  <blockquote className="flex-1 text-sm leading-6 text-foreground">
                    &ldquo;{testimonial.quote}&rdquo;
                  </blockquote>
                  <figcaption className="mt-4 flex items-center gap-3 border-t border-glass-border pt-4">
